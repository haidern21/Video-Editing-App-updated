...
class EditorRewardView extends StatefulWidget {
  @override
  _EditorRewardViewState createState() => _EditorRewardViewState();
}

class _EditorRewardViewState extends State<EditorRewardView> {
                ...
                AnimatedCrossFade(
                  ...
                  firstChild: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => Get.toNamed(Routes.EDITOR_BOTTOM_BAR),
                        child: MyText(
                          text: 'Back to home',
                          size: 14 * sp,
                          weight: ksix,
