...
class EditorProjectDetailsView extends GetView<EditorProjectDetailsController> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Column(
          children: [
            GetBuilder<EditorProjectDetailsController>(builder: (controller) {
              return SizedBox(
                height: controller.visibleContainer == false
                    ? height * 0.85
                    : height * 0.79,
                child: ListView(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        GetBuilder<EditorProjectDetailsController>(
                            builder: (controller) {
                          return Visibility(
                            visible: controller.visibleContainer,
                            child: Container(
                            ...
                            (index) => Column(
                                  ...
                                  children: [
                                    BuildDescriptionContainer(
                                      ...
                                      description: editorOrderController.selectedOrder.value!
                                              .quoteVideos![index].details ??
                                          '',
                                      driveUrl: editorOrderController
                                              .selectedOrder.value!
                                              .quoteVideos![index]
                                              .googleDriveLink ??
                                          '',
                                      videoDuration: editorOrderController
                                              .selectedOrder.value!
                                              .quoteVideos![index]
                                              .numberOfMinutes
                                              .toString() ??
